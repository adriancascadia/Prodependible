export const translations = {
  ...
  ru: {
    ...
    services: {
      ...
      subtitle: "Комплексные решения по ремонту дома с точностью и заботой",
      deck: {
    ...
    contact: {
      ...
      subtitle: "Давайте обсудим ваш проект и воплотим вашу мечту в жизнь",
      name: "Ваше имя",
  ...
  es: {
    ...
    services: {
      ...
      subtitle: "Soluciones integrales de mejoras para el hogar entregadas con precisión y cuidado",
      deck: {
    ...
    // Contact
    contact: {
      title: "Solicite su Cotización Gratuita",
