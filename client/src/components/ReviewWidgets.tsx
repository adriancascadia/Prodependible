  ...
  return (
    <div className="space-y-12">
      ...
      <div className="bg-white rounded-2xl p-8 shadow-xl border-2 border-primary/20">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="text-2xl font-bold text-primary">BBB Accredited Business</h3>
              <p className="text-muted-foreground">Better Business Bureau</p>
            </div>
          </div>
        ...
        <p className="text-muted-foreground mb-4">
          Dependable Home Improvement has maintained an A+ rating with the Better Business Bureau, 
          demonstrating our commitment to ethical business practices and customer satisfaction.
        </p>
        <a 
        ...
        >
          View BBB Profile <ExternalLink className="h-4 w-4" />
        </a>
      </div>
      ...
      <div className="bg-white rounded-2xl p-8 shadow-xl border-2 border-secondary/20">
        ...
        <p className="text-muted-foreground mb-4">
          Proud recipient of the Angi Super Service Award 2025, recognizing exceptional service and customer satisfaction throughout the year.
        </p>
      ...
      <div className="bg-white rounded-2xl p-8 shadow-xl border-2 border-primary/20">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h3 className="text-2xl font-bold text-primary mb-2">Google Reviews</h3>
            <div className="flex items-center gap-2">
              <div className="flex">
                {[1, 2, 3, 4, 5].map((star) => (
                  <Star key={star} className="h-6 w-6 text-secondary fill-secondary" />
              ...
              <span className="text-xl font-bold text-primary">4.8/5.0</span>
